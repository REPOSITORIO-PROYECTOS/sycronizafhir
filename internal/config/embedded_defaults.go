...
var embeddedDefaults = map[string]string{
	...
	"LOCAL_POSTGRES_URL":        "AxYQBggcDAlbSUcZHV5GV0BTAEMBExoaAEIAJllbRQMCHgIYQkNWRlxdRhcAFQsGBkxBD0FFHxQMFgpTDRMSBwoFFw==",
	...
	"SUPABASE_SERVICE_ROLE_KEY": "ABs8AQoNGx8VOVA9AktdQQBvJxg8HzcMCE4ELCAhG1ptfWICI0wTHDg=",
